...
RUN curl -sOL https://github.com/jpillora/chisel/releases/download/v1.7.3/chisel_1.7.3_linux_amd64.gz && gzip -d chisel_*.gz && mv chisel_* /app/bin/chisel && chmod +x /app/bin/chisel
